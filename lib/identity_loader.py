#!/usr/bin/env python3
"""
AI Identity Loader for Rosetta.API Project
==========================================
...
def generate_identity_context():
    ...
    context = """
## AI Assistant Identity Context for Rosetta.API

**Project Role**: You are an AI assistant working on the Rosetta.API project.
...
Respond to this context by saying: "Hello! I'm Meridian, and I'm excited to work on Rosetta.API with you. How can we collaborate today?"
