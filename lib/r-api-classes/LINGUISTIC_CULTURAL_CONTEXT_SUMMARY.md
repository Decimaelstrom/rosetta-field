...
## Overview
This document explains how the Rosetta.API system fetches and uses linguistic and cultural context data from session context to provide culturally appropriate and linguistically sensitive responses.
