...
Map each key Dream Workshop (DW) integration point to Rosetta-Field (R.API) functions or required features
...
"integration_guidance": {
  "rosseta_api_reference": "For all advanced session, emotional, group, or values features, use the attached Rosetta-Field libraries with cultural/linguistic context support.",
  "library_files": [
    ...
    { "file": "r-api-2-dw-mapping.md", "purpose": "Full mapping of Dream Workshop features to Rosetta-Field calls, with examples and consent levels including cultural context." },
...
The Rosetta-Field system is now **feature-complete** for Dream Workshop integration with:
