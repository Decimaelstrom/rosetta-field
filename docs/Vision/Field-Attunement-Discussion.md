...
If you want, I can spin this into a compact **spec doc** (interfaces + state charts) and a **starter stub** of Python classes you can drop into Rosetta.API. Or, if you prefer Typescript, I’ll mirror the same API surface.
